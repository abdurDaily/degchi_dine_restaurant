...
.track-order .to-grid {
    ...
    box-shadow: 0 24px 60px rgba(31, 20, 18, 0.1); border: 1px solid var(--dd-border);
}
...
.track-order .to-help-side > p { color: rgba(255,255,255,0.65); font-size: 0.92rem; line-height: 1.6; margin-bottom: 28px; }
.track-order .to-step {
    display: flex; gap: 14px; margin-bottom: 20px; align-items: flex-start;
}
.track-order .to-step-num {
    width: 34px; height: 34px; border-radius: 50%;
    background: rgba(223, 166, 83, 0.18); border: 1px solid rgba(223, 166, 83, 0.4);
...
.track-order .to-step-text span { font-size: 0.82rem; color: rgba(255,255,255,0.6); line-height: 1.5; }
...
.track-order .to-example-row { font-size: 0.82rem; color: rgba(255,255,255,0.75); margin-bottom: 5px; }
.track-order .to-example-row code {
    color: var(--dd-gold); background: rgba(0,0,0,0.25);
...
.track-order .to-icon-ring {
    ...
    background: linear-gradient(135deg, rgba(127,36,48,0.12), rgba(223,166,83,0.15));
    border: 2px solid rgba(223, 166, 83, 0.35);
        ...
        <div class="to-grid">
            ...
            <div class="to-form-side">
                ...
                <form method="POST" action="{{ route('frontend.order.track.submit') }}" class="dd-apply-form-element">
                    ...
                    <div class="dd-input-group">
                        <input type="tel" name="phone" id="track_phone" class="dd-input-field" placeholder=" " value="{{ old('phone') }}" required>
