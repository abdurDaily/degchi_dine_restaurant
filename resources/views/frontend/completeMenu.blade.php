...
@push('front_js')
    <script>
        $(function() {
            ...
            setFilterTopVar();
            window.addEventListener('resize', setFilterTopVar, {
                passive: true
            });
            ...
            $doc.on('change', '.menu-category-checkbox', function() {
                ...
                if (isOffer) {
                    // Offer selected হলে বাকি সব বাদ (mutually exclusive)
                    if (this.checked) {
                        $('.menu-category-checkbox').not(this).prop('checked', false);
                    }
                } else if (isPopular) {
                    // Popular সিলেক্ট করলে বাকি সব বাদ (mutually exclusive)
                    if (this.checked) {
                        $('.menu-category-checkbox').not(this).prop('checked', false);
                    }
                } else {
                    // নরমাল category সিলেক্ট হলে offer/popular বাদ
