...
<x-frontend.page-header
    title="Request Your Privileges"
    eyebrow="Exclusive Access"
    subtitle="Join our inner circle to unlock a world of bespoke culinary experiences."
    :backLink="route('frontend.cards')"
            ...
            <aside class="contact-page-info order-2 order-lg-1">
                <div class="contact-page-info-panel">
                    ...
                    <div style="margin-bottom: 1.25rem;">
                        <h3 style="font-size: 0.95rem; font-weight: 700; color: #fff; margin-bottom: 1rem;">Membership Perks</h3>

                        <div class="dd-perk-row">
                            <div class="dd-perk-icon"><iconify-icon icon="solar:verified-check-linear"></iconify-icon></div>
                        ...
                        <div class="dd-perk-row">
                            <div class="dd-perk-icon"><iconify-icon icon="solar:wad-of-money-linear"></iconify-icon></div>
                            <div class="dd-perk-text">
            ...
            <div class="contact-page-forms order-1 order-lg-2">
                <div class="contact-form-sticky">
                    <div class="cp-form-card cp-form-card-verify">
                        ...
                        <form id="privilegeCardForm" method="POST" action="{{ route('frontend.members.register') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div style="margin-bottom: 1.35rem;">
                                ...
                                <div class="cp-field mb-3">
                                    ...
                                    <input type="text" name="name" id="dd_name" class="cp-input" placeholder="Ex: Rahim Uddin" value="{{ old('name') }}" required autocomplete="name">
                                </div>

                                <div class="cp-grid-2">
                                    <div class="cp-field">
                                        <label for="dd_phone" class="cp-label">Phone Number</label>
                                        <input type="tel" name="phone" id="dd_phone" class="cp-input" placeholder="Ex: 01712345678" value="{{ old('phone') }}" required autocomplete="tel">
                                    </div>
                                    <div class="cp-field">
                                        <label for="dd_email" class="cp-label">Email Address</label>
                                        <input type="email" name="email" id="dd_email" class="cp-input" placeholder="Ex: you@email.com" value="{{ old('email') }}" required autocomplete="email">
                                    </div>
                                </div>
                                <div id="dd_phone_feedback" class="dd-phone-feedback d-none" role="status"></div>
                                <p class="cp-field-hint">Email is required for password recovery. You can also sign in with email at <a href="{{ route('frontend.member.login') }}">Member Login</a>.</p>

                                <div class="cp-grid-2">
                                    <div class="cp-field">
                                        <label for="dd_password" class="cp-label">Create Password</label>
                                        <input type="password" name="password" id="dd_password" class="cp-input" placeholder="Min 8 characters" required minlength="8" autocomplete="new-password">
                                    </div>
                                    <div class="cp-field">
                                        <label for="dd_password_confirm" class="cp-label">Confirm Password</label>
                                        <input type="password" name="password_confirmation" id="dd_password_confirm" class="cp-input" placeholder="Re-enter password" required minlength="8" autocomplete="new-password">
                                    </div>
                                </div>
                                <p class="cp-field-hint">At least 8 characters. Sign in later with your <strong style="color: #fff;">phone</strong>, <strong style="color: #fff;">email</strong>, or <strong style="color: #fff;">card number</strong> plus this password.</p>
                            </div>
                            ...
                            <div style="margin-bottom: 1.35rem;">
                                ...
                                <div class="cp-grid-2">
                                    <div class="cp-field">
                                        ...
                                        <input type="date" name="dob" id="dd_dob" class="cp-input" value="{{ old('dob') }}" required>
                                    </div>
                                    <div class="cp-field">
                                        <label for="dd_marriage" class="cp-label">Marriage Date (optional)</label>
                                        <input type="date" name="marriage_date" id="dd_marriage" class="cp-input" value="{{ old('marriage_date') }}">
                                    </div>
                                </div>

                                <div class="cp-field mt-3">
                                    <label for="dd_address" class="cp-label">Address</label>
                                    <textarea name="address" id="dd_address" class="cp-input cp-textarea" rows="2" placeholder="Your full address" required>{{ old('address') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div style="margin-bottom: 1.35rem;">
                                ...
                                <div class="cp-dropzone" id="profile_image_dropzone">
                                    <input type="file" name="profile_image" id="dd_profile_image" class="cp-dropzone-input" accept="image/webp,image/png,image/jpeg">
                                    <iconify-icon icon="solar:gallery-add-linear" class="cp-dropzone-icon"></iconify-icon>
                            ...
                            <div style="margin-bottom: 1.35rem;">
                                ...
                                <div id="student_extra_fields" class="{{ old('is_student') ? '' : 'd-none' }}">
                                    <div id="student_discount_info" class="cp-student-info">
                                        <div class="cp-student-info-inner">
                                            ...
                                            <div>
                                                ...
                                                <p>Students get <strong>35%</strong> on the first order (vs <strong>30%</strong> for other members). Upload your student ID to verify.</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="cp-dropzone" id="student_card_dropzone">
                                        <input type="file" name="student_card" id="dd_student_card" class="cp-dropzone-input" accept="image/png,image/jpeg,image/jpg,application/pdf">
                                        <iconify-icon icon="solar:document-add-linear" class="cp-dropzone-icon"></iconify-icon>
                                    ...
                                    <div class="d-none mb-3" id="student_card_preview_wrap">
                                        ...
                                        <div id="student_card_pdf_indicator" class="d-none" style="text-align:center; padding:18px; border:1.5px dashed var(--secondary-30); border-radius:14px; background:var(--secondary-10);">
                                            <iconify-icon icon="solar:document-bold" style="font-size:2.5rem; color:var(--brand-secondary);"></iconify-icon>
                                            <div style="margin-top:6px; font-size:.85rem; font-weight:600; color:#fff;" id="student_card_pdf_name"></div>
                                            <div style="font-size:.75rem; color:var(--text-on-dark-muted); margin-top:2px;">PDF document ready to upload</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button type="submit" id="privilegeSubmitBtn" class="btn-dine btn-dine-primary btn-dine-sm w-100">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function showSuccessPopup(message, cardNumber, dashboardUrl){
            ...
            var cardHtml = cardNumber ? '<div style="background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);border-radius:12px;padding:14px 20px;margin-bottom:16px;"><div style="font-size:.75rem;color:rgba(255,255,255,0.6);text-transform:uppercase;letter-spacing:.06em;margin-bottom:4px;">Your Card Number</div><div style="font-size:1.3rem;font-weight:800;color:#ff6b35;letter-spacing:.08em;">' + cardNumber + '</div><div style="font-size:.75rem;color:rgba(255,255,255,0.6);margin-top:4px;">Save this — use it at checkout for discounts</div></div>' : '';

            var dashBtnHtml = dashboardUrl ? '<a href="' + dashboardUrl + '" style="display:block;background:linear-gradient(135deg,#ff6b35,#e63946);color:#fff;border:none;padding:13px 32px;border-radius:999px;font-size:.95rem;font-weight:700;cursor:pointer;width:100%;text-decoration:none;margin-bottom:10px;">Go to My Dashboard</a>' : '';

            var box = document.createElement('div');
            box.style.cssText = 'background:#0f4a55;border-radius:20px;padding:40px 36px;max-width:440px;width:90%;text-align:center;box-shadow:0 24px 60px rgba(0,0,0,.35);border:1px solid rgba(255,255,255,0.08);animation:successPopIn .4s cubic-bezier(.34,1.56,.64,1);';
            box.innerHTML = '<div style="font-size:3.5rem;margin-bottom:12px;">\uD83C\uDF89</div>' +
                ...
                '<p style="color:rgba(255,255,255,0.85);font-size:.93rem;line-height:1.6;margin-bottom:' + (cardNumber ? '16px' : '24px') + ';">' + message + '</p>' +
                cardHtml +
            ...
            overlay.querySelector('#successPopupClose').addEventListener('click', function(){ overlay.remove(); });
            if (dashboardUrl) {
                var dashLink = overlay.querySelector('a[href="' + dashboardUrl + '"]');
                if (dashLink) dashLink.addEventListener('click', function(){ overlay.remove(); });
            }
        ...
        function showErrorPopup(message){
            ...
            var box = document.createElement('div');
            box.style.cssText = 'background:#0f4a55;border-radius:20px;padding:36px;max-width:400px;width:90%;text-align:center;box-shadow:0 20px 50px rgba(0,0,0,.3);border:1px solid rgba(255,255,255,0.08);';
            box.innerHTML = '<div style="font-size:3rem;margin-bottom:10px;">\u26A0\uFE0F</div>' +
                ...
                '<p style="color:rgba(255,255,255,0.85);font-size:.9rem;line-height:1.55;margin-bottom:20px;">' + message + '</p>' +
            ...
            overlay.querySelector('#errPopupClose').addEventListener('click', function(){ overlay.remove(); });
            overlay.addEventListener('click', function(e){ if(e.target===overlay) overlay.remove(); });
        }
    });
</script>
