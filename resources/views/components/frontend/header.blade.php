  ...
  <div class="container px-4 px-xxl-5">
    <a class="navbar-brand" href="{{ route('frontend.home') }}">
      <div class="logo-badge-wrapper">
        <img src="{{ asset('assets/frontend/images/logo.webp') }}" alt="Degchi Dine - Authentic Kacchi & Bangla Restaurant" class="nav-logo-img" loading="eager" />
      </div>
    </a>
...
<nav class="navbar py-0 navbar-light mobile-topbar d-lg-none sticky-top">
  <div class="container-fluid px-3 px-sm-4">
    ...
    <a class="navbar-brand mobile-nav-brand" href="{{ route('frontend.home') }}#home">
      <img src="{{ asset('assets/frontend/images/logo.webp') }}" class="mobile-logo-img" alt="Degchi Dine Restaurant" loading="eager" />
    </a>
...
<div class="offcanvas offcanvas-start mobile-sidebar" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
  <div class="offcanvas-header">
    <h5 class="offcanvas-title" id="mobileMenuLabel">
      <img src="{{ asset('assets/frontend/images/logo.webp') }}" class="offcanvas-logo-img" alt="Degchi Dine Restaurant" />
    </h5>
