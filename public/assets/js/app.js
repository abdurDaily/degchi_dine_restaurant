! function() {
    ...
    function r() {
        ...
        var e = document.documentElement.clientWidth,
            e = (e < 1025 && 767 < e ? (document.body.classList.remove("twocolumn-panel"), "twocolumn" == localStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), i(), u(), s()), "vertical" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"), "semibox" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.add("open")) : 1025 <= e ? (document.body.classList.remove("twocolumn-panel"), "twocolumn" == localStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), i(), u(), s()), "vertical" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size")), "semibox" == localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size")), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.remove("open")) : e <= 767 && (document.body.classList.remove("vertical-sidebar-enable"), document.body.classList.add("twocolumn-panel"), "twocolumn" == localStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "vertical"), y("vertical"), s()), "horizontal" != localStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "lg"), document.querySelector(".hamburger-icon")) && document.querySelector(".hamburger-icon").classList.add("open"), document.querySelectorAll("#navbar-nav > li.nav-item"));
        Array.from(e).forEach(function(e) {
    ...
    function e(e) {
        if (e == e) {
            switch (e["data-theme"]) {
                case "default":
                    T("data-theme", "default"), localStorage.setItem("data-theme", "default"), document.documentElement.setAttribute("data-theme", "default");
                    break;
                case "minimal":
                    T("data-theme", "minimal"), localStorage.setItem("data-theme", "minimal"), document.documentElement.setAttribute("data-theme", "minimal");
                    break;
                case "saas":
                    T("data-theme", "saas"), localStorage.setItem("data-theme", "saas"), document.documentElement.setAttribute("data-theme", "saas");
                    break;
                case "corporate":
                    T("data-theme", "corporate"), localStorage.setItem("data-theme", "corporate"), document.documentElement.setAttribute("data-theme", "corporate");
                    break;
                case "galaxy":
                    T("data-theme", "galaxy"), localStorage.setItem("data-theme", "galaxy"), document.documentElement.setAttribute("data-theme", "galaxy");
                    break;
                case "material":
                    T("data-theme", "material"), localStorage.setItem("data-theme", "material"), document.documentElement.setAttribute("data-theme", "material");
                    break;
                case "creative":
                    T("data-theme", "creative"), localStorage.setItem("data-theme", "creative"), document.documentElement.setAttribute("data-theme", "creative");
                    break;
                case "minimal":
                    T("data-theme", "minimal"), localStorage.setItem("data-theme", "minimal"), document.documentElement.setAttribute("data-theme", "minimal");
                    break;
                case "modern":
                    T("data-theme", "modern"), localStorage.setItem("data-theme", "modern"), document.documentElement.setAttribute("data-theme", "modern");
                    break;
                case "interactive":
                    T("data-theme", "interactive"), localStorage.setItem("data-theme", "interactive"), document.documentElement.setAttribute("data-theme", "interactive");
                    break;
                case "classic":
                    T("data-theme", "classic"), localStorage.setItem("data-theme", "classic"), document.documentElement.setAttribute("data-theme", "classic");
                    break;
                case "vintage":
                    T("data-theme", "vintage"), localStorage.setItem("data-theme", "vintage"), document.documentElement.setAttribute("data-theme", "vintage");
                    break;
                default:
                    T("data-theme", "default"), localStorage.setItem("data-theme", "default"), document.documentElement.setAttribute("data-theme", "default")
            }
            switch (e["data-layout"]) {
                case "vertical":
                    T("data-layout", "vertical"), localStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), y("vertical"), s();
                    break;
                case "horizontal":
                    T("data-layout", "horizontal"), localStorage.setItem("data-layout", "horizontal"), document.documentElement.setAttribute("data-layout", "horizontal"), y("horizontal");
                    break;
                case "twocolumn":
                    T("data-layout", "twocolumn"), localStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn"), y("twocolumn");
                    break;
                case "semibox":
                    T("data-layout", "semibox"), localStorage.setItem("data-layout", "semibox"), document.documentElement.setAttribute("data-layout", "semibox"), y("semibox");
                    break;
                default:
                    "vertical" == localStorage.getItem("data-layout") && localStorage.getItem("data-layout") ? (T("data-layout", "vertical"), localStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), y("vertical"), s()) : "horizontal" == localStorage.getItem("data-layout") ? (T("data-layout", "horizontal"), localStorage.setItem("data-layout", "horizontal"), document.documentElement.setAttribute("data-layout", "horizontal"), y("horizontal")) : "twocolumn" == localStorage.getItem("data-layout") ? (T("data-layout", "twocolumn"), localStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn"), y("twocolumn")) : "semibox" == localStorage.getItem("data-layout") && (T("data-layout", "semibox"), localStorage.setItem("data-layout", "semibox"), document.documentElement.setAttribute("data-layout", "semibox"), y("semibox"))
            }
            switch (e["data-topbar"]) {
                case "light":
                    T("data-topbar", "light"), localStorage.setItem("data-topbar", "light"), document.documentElement.setAttribute("data-topbar", "light");
                    break;
                case "dark":
                    T("data-topbar", "dark"), localStorage.setItem("data-topbar", "dark"), document.documentElement.setAttribute("data-topbar", "dark");
                    break;
                default:
                    "dark" == localStorage.getItem("data-topbar") ? (T("data-topbar", "dark"), localStorage.setItem("data-topbar", "dark"), document.documentElement.setAttribute("data-topbar", "dark")) : (T("data-topbar", "light"), localStorage.setItem("data-topbar", "light"), document.documentElement.setAttribute("data-topbar", "light"))
            }
            switch ("hidden" === e["data-sidebar-visibility"] ? (T("data-sidebar-visibility", "hidden"), localStorage.setItem("data-sidebar-visibility", "hidden"), document.documentElement.setAttribute("data-sidebar-visibility", "hidden")) : (T("data-sidebar-visibility", "show"), localStorage.setItem("data-sidebar-visibility", "show"), document.documentElement.setAttribute("data-sidebar-visibility", "show")), e["data-layout-style"]) {
                case "default":
                    T("data-layout-style", "default"), localStorage.setItem("data-layout-style", "default"), document.documentElement.setAttribute("data-layout-style", "default");
                    break;
                case "detached":
                    T("data-layout-style", "detached"), localStorage.setItem("data-layout-style", "detached"), document.documentElement.setAttribute("data-layout-style", "detached");
                    break;
                default:
                    "detached" == localStorage.getItem("data-layout-style") ? (T("data-layout-style", "detached"), localStorage.setItem("data-layout-style", "detached"), document.documentElement.setAttribute("data-layout-style", "detached")) : (T("data-layout-style", "default"), localStorage.setItem("data-layout-style", "default"), document.documentElement.setAttribute("data-layout-style", "default"))
            }
            switch (e["data-sidebar-size"]) {
                case "lg":
                    T("data-sidebar-size", "lg"), document.documentElement.setAttribute("data-sidebar-size", "lg"), localStorage.setItem("data-sidebar-size", "lg");
                    break;
                case "sm":
                    T("data-sidebar-size", "sm"), document.documentElement.setAttribute("data-sidebar-size", "sm"), localStorage.setItem("data-sidebar-size", "sm");
                    break;
                case "md":
                    T("data-sidebar-size", "md"), document.documentElement.setAttribute("data-sidebar-size", "md"), localStorage.setItem("data-sidebar-size", "md");
                    break;
                case "sm-hover":
                    T("data-sidebar-size", "sm-hover"), document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), localStorage.setItem("data-sidebar-size", "sm-hover");
                    break;
                default:
                    "sm" == localStorage.getItem("data-sidebar-size") ? (document.documentElement.setAttribute("data-sidebar-size", "sm"), T("data-sidebar-size", "sm"), localStorage.setItem("data-sidebar-size", "sm")) : "md" == localStorage.getItem("data-sidebar-size") ? (document.documentElement.setAttribute("data-sidebar-size", "md"), T("data-sidebar-size", "md"), localStorage.setItem("data-sidebar-size", "md")) : "sm-hover" == localStorage.getItem("data-sidebar-size") ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), T("data-sidebar-size", "sm-hover"), localStorage.setItem("data-sidebar-size", "sm-hover")) : (document.documentElement.setAttribute("data-sidebar-size", "lg"), T("data-sidebar-size", "lg"), localStorage.setItem("data-sidebar-size", "lg"))
            }
            switch (e["data-bs-theme"]) {
                case "light":
                    T("data-bs-theme", "light"), document.documentElement.setAttribute("data-bs-theme", "light"), localStorage.setItem("data-bs-theme", "light");
                    break;
                case "dark":
                    T("data-bs-theme", "dark"), document.documentElement.setAttribute("data-bs-theme", "dark"), localStorage.setItem("data-bs-theme", "dark");
                    break;
                default:
                    localStorage.getItem("data-bs-theme") && "dark" == localStorage.getItem("data-bs-theme") ? (localStorage.setItem("data-bs-theme", "dark"), document.documentElement.setAttribute("data-bs-theme", "dark"), T("data-bs-theme", "dark")) : (localStorage.setItem("data-bs-theme", "light"), document.documentElement.setAttribute("data-bs-theme", "light"), T("data-bs-theme", "light"))
            }
            switch (e["data-layout-width"]) {
                case "fluid":
                    T("data-layout-width", "fluid"), document.documentElement.setAttribute("data-layout-width", "fluid"), localStorage.setItem("data-layout-width", "fluid");
                    break;
                case "boxed":
                    T("data-layout-width", "boxed"), document.documentElement.setAttribute("data-layout-width", "boxed"), localStorage.setItem("data-layout-width", "boxed");
                    break;
                default:
                    "boxed" == localStorage.getItem("data-layout-width") ? (localStorage.setItem("data-layout-width", "boxed"), document.documentElement.setAttribute("data-layout-width", "boxed"), T("data-layout-width", "boxed")) : (localStorage.setItem("data-layout-width", "fluid"), document.documentElement.setAttribute("data-layout-width", "fluid"), T("data-layout-width", "fluid"))
            }
            switch (e["data-sidebar"]) {
                case "light":
                    T("data-sidebar", "light"), localStorage.setItem("data-sidebar", "light"), document.documentElement.setAttribute("data-sidebar", "light");
                    break;
                case "dark":
                    T("data-sidebar", "dark"), localStorage.setItem("data-sidebar", "dark"), document.documentElement.setAttribute("data-sidebar", "dark");
                    break;
                case "gradient":
                    T("data-sidebar", "gradient"), localStorage.setItem("data-sidebar", "gradient"), document.documentElement.setAttribute("data-sidebar", "gradient");
                    break;
                case "gradient-2":
                    T("data-sidebar", "gradient-2"), localStorage.setItem("data-sidebar", "gradient-2"), document.documentElement.setAttribute("data-sidebar", "gradient-2");
                    break;
                case "gradient-3":
                    T("data-sidebar", "gradient-3"), localStorage.setItem("data-sidebar", "gradient-3"), document.documentElement.setAttribute("data-sidebar", "gradient-3");
                    break;
                case "gradient-4":
                    T("data-sidebar", "gradient-4"), localStorage.setItem("data-sidebar", "gradient-4"), document.documentElement.setAttribute("data-sidebar", "gradient-4");
                    break;
                default:
                    localStorage.getItem("data-sidebar") && "light" == localStorage.getItem("data-sidebar") ? (localStorage.setItem("data-sidebar", "light"), T("data-sidebar", "light"), document.documentElement.setAttribute("data-sidebar", "light")) : "dark" == localStorage.getItem("data-sidebar") ? (localStorage.setItem("data-sidebar", "dark"), T("data-sidebar", "dark"), document.documentElement.setAttribute("data-sidebar", "dark")) : "gradient" == localStorage.getItem("data-sidebar") ? (localStorage.setItem("data-sidebar", "gradient"), T("data-sidebar", "gradient"), document.documentElement.setAttribute("data-sidebar", "gradient")) : "gradient-2" == localStorage.getItem("data-sidebar") ? (localStorage.setItem("data-sidebar", "gradient-2"), T("data-sidebar", "gradient-2"), document.documentElement.setAttribute("data-sidebar", "gradient-2")) : "gradient-3" == localStorage.getItem("data-sidebar") ? (localStorage.setItem("data-sidebar", "gradient-3"), T("data-sidebar", "gradient-3"), document.documentElement.setAttribute("data-sidebar", "gradient-3")) : "gradient-4" == localStorage.getItem("data-sidebar") && (localStorage.setItem("data-sidebar", "gradient-4"), T("data-sidebar", "gradient-4"), document.documentElement.setAttribute("data-sidebar", "gradient-4"))
            }
            switch (e["data-sidebar-image"]) {
                case "none":
                    T("data-sidebar-image", "none"), localStorage.setItem("data-sidebar-image", "none"), document.documentElement.setAttribute("data-sidebar-image", "none");
                    break;
                case "img-1":
                    T("data-sidebar-image", "img-1"), localStorage.setItem("data-sidebar-image", "img-1"), document.documentElement.setAttribute("data-sidebar-image", "img-1");
                    break;
                case "img-2":
                    T("data-sidebar-image", "img-2"), localStorage.setItem("data-sidebar-image", "img-2"), document.documentElement.setAttribute("data-sidebar-image", "img-2");
                    break;
                case "img-3":
                    T("data-sidebar-image", "img-3"), localStorage.setItem("data-sidebar-image", "img-3"), document.documentElement.setAttribute("data-sidebar-image", "img-3");
                    break;
                case "img-4":
                    T("data-sidebar-image", "img-4"), localStorage.setItem("data-sidebar-image", "img-4"), document.documentElement.setAttribute("data-sidebar-image", "img-4");
                    break;
                default:
                    localStorage.getItem("data-sidebar-image") && "none" == localStorage.getItem("data-sidebar-image") ? (localStorage.setItem("data-sidebar-image", "none"), T("data-sidebar-image", "none"), document.documentElement.setAttribute("data-sidebar-image", "none")) : "img-1" == localStorage.getItem("data-sidebar-image") ? (localStorage.setItem("data-sidebar-image", "img-1"), T("data-sidebar-image", "img-1"), document.documentElement.setAttribute("data-sidebar-image", "img-2")) : "img-2" == localStorage.getItem("data-sidebar-image") ? (localStorage.setItem("data-sidebar-image", "img-2"), T("data-sidebar-image", "img-2"), document.documentElement.setAttribute("data-sidebar-image", "img-2")) : "img-3" == localStorage.getItem("data-sidebar-image") ? (localStorage.setItem("data-sidebar-image", "img-3"), T("data-sidebar-image", "img-3"), document.documentElement.setAttribute("data-sidebar-image", "img-3")) : "img-4" == localStorage.getItem("data-sidebar-image") && (localStorage.setItem("data-sidebar-image", "img-4"), T("data-sidebar-image", "img-4"), document.documentElement.setAttribute("data-sidebar-image", "img-4"))
            }
            switch (e["data-layout-position"]) {
                case "fixed":
                    T("data-layout-position", "fixed"), localStorage.setItem("data-layout-position", "fixed"), document.documentElement.setAttribute("data-layout-position", "fixed");
                    break;
                case "scrollable":
                    T("data-layout-position", "scrollable"), localStorage.setItem("data-layout-position", "scrollable"), document.documentElement.setAttribute("data-layout-position", "scrollable");
                    break;
                default:
                    localStorage.getItem("data-layout-position") && "scrollable" == localStorage.getItem("data-layout-position") ? (T("data-layout-position", "scrollable"), localStorage.setItem("data-layout-position", "scrollable"), document.documentElement.setAttribute("data-layout-position", "scrollable")) : (T("data-layout-position", "fixed"), localStorage.setItem("data-layout-position", "fixed"), document.documentElement.setAttribute("data-layout-position", "fixed"))
            }
            switch (e["data-preloader"]) {
                case "disable":
                    T("data-preloader", "disable"), localStorage.setItem("data-preloader", "disable"), document.documentElement.setAttribute("data-preloader", "disable");
                    break;
                case "enable":
                    T("data-preloader", "enable"), localStorage.setItem("data-preloader", "enable"), document.documentElement.setAttribute("data-preloader", "enable"), (t = document.getElementById("preloader")) && window.addEventListener("load", function() {
                        t.style.opacity = "0", t.style.visibility = "hidden"
                    });
                    break;
                default:
                    var t;
                    localStorage.getItem("data-preloader") && "disable" == localStorage.getItem("data-preloader") ? (T("data-preloader", "disable"), localStorage.setItem("data-preloader", "disable"), document.documentElement.setAttribute("data-preloader", "disable")) : "enable" == localStorage.getItem("data-preloader") ? (T("data-preloader", "enable"), localStorage.setItem("data-preloader", "enable"), document.documentElement.setAttribute("data-preloader", "enable"), (t = document.getElementById("preloader")) && window.addEventListener("load", function() {
                        t.style.opacity = "0", t.style.visibility = "hidden"
                    })) : document.documentElement.setAttribute("data-preloader", "disable")
            }
            switch (e["data-theme-colors"]) {
                case "default":
                    T("data-theme-colors", "default"), localStorage.setItem("data-theme-colors", "default"), document.documentElement.setAttribute("data-theme-colors", "default");
                    break;
                case "green":
                    T("data-theme-colors", "green"), localStorage.setItem("data-theme-colors", "green"), document.documentElement.setAttribute("data-theme-colors", "green");
                    break;
                case "purple":
                    T("data-theme-colors", "purple"), localStorage.setItem("data-theme-colors", "purple"), document.documentElement.setAttribute("data-theme-colors", "purple");
                    break;
                case "blue":
                    T("data-theme-colors", "blue"), localStorage.setItem("data-theme-colors", "blue"), document.documentElement.setAttribute("data-theme-colors", "blue");
                    break;
                default:
                    T("data-theme-colors", "default"), localStorage.setItem("data-theme-colors", "default"), document.documentElement.setAttribute("data-theme-colors", "default")
            }
            switch (e["data-body-image"]) {
                case "img-1":
                    T("data-body-image", "img-1"), localStorage.setItem("data-body-image", "img-1"), document.documentElement.setAttribute("data-body-image", "img-1"), document.getElementById("theme-settings-offcanvas") && document.documentElement.removeAttribute("data-sidebar-image");
                    break;
                case "img-2":
                    T("data-body-image", "img-2"), localStorage.setItem("data-body-image", "img-2"), document.documentElement.setAttribute("data-body-image", "img-2");
                    break;
                case "img-3":
                    T("data-body-image", "img-3"), localStorage.setItem("data-body-image", "img-3"), document.documentElement.setAttribute("data-body-image", "img-3");
                    break;
                case "none":
                    T("data-body-image", "none"), localStorage.setItem("data-body-image", "none"), document.documentElement.setAttribute("data-body-image", "none");
                    break;
                default:
                    localStorage.getItem("data-body-image") && "img-1" == localStorage.getItem("data-body-image") ? (localStorage.setItem("data-body-image", "img-1"), T("data-body-image", "img-1"), document.documentElement.setAttribute("data-body-image", "img-1"), document.getElementById("theme-settings-offcanvas") && document.getElementById("sidebar-img") && (document.getElementById("sidebar-img").style.display = "none", document.documentElement.removeAttribute("data-sidebar-image"))) : "img-2" == localStorage.getItem("data-body-image") ? (localStorage.setItem("data-body-image", "img-2"), T("data-body-image", "img-2"), document.documentElement.setAttribute("data-body-image", "img-2")) : "img-3" == localStorage.getItem("data-body-image") ? (localStorage.setItem("data-body-image", "img-3"), T("data-body-image", "img-3"), document.documentElement.setAttribute("data-body-image", "img-3")) : (localStorage.setItem("data-body-image", "none"), T("data-body-image", "none"), document.documentElement.setAttribute("data-body-image", "none"))
            }
        }
    }
    ...
    function T(n, e) {
        Array.from(document.querySelectorAll("input[name=" + n + "]")).forEach(function(a) {
            e == a.value ? a.checked = !0 : a.checked = !1, a.addEventListener("change", function() {
                document.documentElement.setAttribute(n, a.value), localStorage.setItem(n, a.value), o(), "data-layout-width" == n && "boxed" == a.value ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), localStorage.setItem("data-sidebar-size", "sm-hover"), document.getElementById("sidebar-size-small-hover").checked = !0) : "data-layout-width" == n && "fluid" == a.value && (document.documentElement.setAttribute("data-sidebar-size", "lg"), localStorage.setItem("data-sidebar-size", "lg"), document.getElementById("sidebar-size-default").checked = !0), "data-layout" == n && ("vertical" == a.value ? (y("vertical"), s(), feather.replace()) : "horizontal" == a.value ? (document.getElementById("sidebarimg-none") && document.getElementById("sidebarimg-none").click(), y("horizontal"), feather.replace()) : "twocolumn" == a.value ? (y("twocolumn"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), i(), u(), s(), feather.replace()) : "semibox" == a.value && (y("semibox"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), document.documentElement.setAttribute("data-layout-style", "default"), document.getElementById("sidebar-view-default").click(), s(), feather.replace()));
                var e, t = "block";
                "semibox" == document.documentElement.getAttribute("data-layout") && ("hidden" == document.documentElement.getAttribute("data-sidebar-visibility") ? (document.documentElement.removeAttribute("data-sidebar"), document.documentElement.removeAttribute("data-sidebar-image"), document.documentElement.removeAttribute("data-sidebar-size"), t = "none") : (document.documentElement.setAttribute("data-sidebar", localStorage.getItem("data-sidebar")), document.documentElement.setAttribute("data-sidebar-image", localStorage.getItem("data-sidebar-image")), document.documentElement.setAttribute("data-sidebar-size", localStorage.getItem("data-sidebar-size")))), document.getElementById("sidebar-size").style.display = t, document.getElementById("sidebar-color").style.display = t, document.getElementById("sidebar-img") && (document.getElementById("sidebar-img").style.display = t), "data-preloader" == n && "enable" == a.value ? (document.documentElement.setAttribute("data-preloader", "enable"), (e = document.getElementById("preloader")) && setTimeout(function() {
                    e.style.opacity = "0", e.style.visibility = "hidden"
                }, 1e3), document.getElementById("customizerclose-btn").click()) : "data-preloader" == n && "disable" == a.value && (document.documentElement.setAttribute("data-preloader", "disable"), document.getElementById("customizerclose-btn").click()), "data-bs-theme" != n && "data-theme" != n && "data-theme-colors" != n || window.dispatchEvent(x), "data-theme" == n && (document.documentElement.setAttribute("data-theme", a.value), document.getElementById("body-img").style.display = "galaxy" === a.value ? "block" : "none", "galaxy" === a.value ? (document.documentElement.setAttribute("data-sidebar", "dark"), document.documentElement.setAttribute("data-bs-theme", "dark")) : (document.documentElement.setAttribute("data-sidebar", localStorage.getItem("data-sidebar")), document.documentElement.setAttribute("data-bs-theme", localStorage.getItem("data-bs-theme")))), "data-theme-colors" != n && "data-theme" != n || setTimeout(() => {
    ...
    localStorage.getItem("defaultAttribute") ? ((h = {})["data-layout"] = localStorage.getItem("data-layout"), h["data-sidebar-size"] = localStorage.getItem("data-sidebar-size"), h["data-bs-theme"] = localStorage.getItem("data-bs-theme"), h["data-layout-width"] = localStorage.getItem("data-layout-width"), h["data-sidebar"] = localStorage.getItem("data-sidebar"), h["data-sidebar-image"] = localStorage.getItem("data-sidebar-image"), h["data-layout-position"] = localStorage.getItem("data-layout-position"), h["data-layout-style"] = localStorage.getItem("data-layout-style"), h["data-topbar"] = localStorage.getItem("data-topbar"), h["data-preloader"] = localStorage.getItem("data-preloader"), h["data-body-image"] = localStorage.getItem("data-body-image"), h["data-theme"] = localStorage.getItem("data-theme"), h["data-theme-colors"] = localStorage.getItem("data-theme-colors"), e(h)) : (L = document.documentElement.attributes, h = {}, Array.from(L).forEach(function(e) {
        var t;
        e && e.nodeName && "undefined" != e.nodeName && (t = e.nodeName, h[t] = e.nodeValue, localStorage.setItem(t, e.nodeValue))
    }), localStorage.setItem("defaultAttribute", JSON.stringify(h)), e(h), (L = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && L.click()), document.getElementById("sidebarUserProfile")?.addEventListener("click", function(e) {
